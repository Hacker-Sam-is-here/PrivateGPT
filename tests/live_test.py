...
def list_providers():
    ...
    provider_module = sys.modules['private_gpt.Provider']
    ...
    table = Table(title="Private_GPT Providers")
...
def test_all_providers(api_keys=None, prompt="Say 'Hello World' in one word"):
    ...
    # Print summary table
    table = Table(title="Private_GPT Live Test Results")
...
def main():
    parser = argparse.ArgumentParser(description="Private_GPT Live Provider Tester")
