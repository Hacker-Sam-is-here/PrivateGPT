...
from private_gpt.Provider.AISEARCH import (
    AyeSoul,
    IAsk,
    Monica,
    PERPLEXED,
...
from private_gpt.AIbase import SearchResponse
...
class TestAISEARCHProviders(unittest.TestCase):
    ...
    @patch("private_gpt.Provider.AISEARCH.iask_search.AsyncSession")
    ...
    @patch("private_gpt.Provider.AISEARCH.monica_search.requests.Session.post")
    ...
    @patch("private_gpt.Provider.AISEARCH.webpilotai_search.requests.Session.post")
    ...
    @patch("private_gpt.Provider.AISEARCH.PERPLEXED_search.requests.Session.post")
    ...
    @patch("private_gpt.Provider.AISEARCH.Perplexity.requests.Session.post")
    ...
    @patch("private_gpt.Provider.AISEARCH.ayesoul_search.aiohttp.ClientSession")
