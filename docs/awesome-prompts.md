# 🚀 Private_GPT Awesome Prompts Manager
> Last updated: 2025-12-20
> Maintained by [Private_GPT](https://github.com/OEvortex/Private_GPT)

Private_GPT's Awesome Prompts Manager provides a comprehensive system for managing and utilizing AI personas and specialized prompts. This module offers optimized prompt retrieval, caching, and management capabilities for enhanced AI interactions.
...
### [`prompt_manager.py`](../private_gpt/prompt_manager.py:1)

The main prompt management module that provides comprehensive prompt handling capabilities.

```python
from private_gpt.prompt_manager import AwesomePrompts
...
### [`AwesomePrompts` Class](../private_gpt/prompt_manager.py:22)
...
| `local_path` | `Optional[str]` | `~/.private_gpt/awesome-prompts.json` | Where to save prompts locally |
...
### Using with Private_GPT Providers
...
production_manager = AwesomePrompts(
    ...
    local_path="/var/lib/private_gpt/prompts.json",
    auto_update=True,
    cache_size=512,
    timeout=30,
    max_workers=8
...
*This documentation covers the comprehensive functionality of the [`private_gpt.prompt_manager`](../private_gpt/prompt_manager.py:1) module. For the most up-to-date information, refer to the source code and inline documentation.*
