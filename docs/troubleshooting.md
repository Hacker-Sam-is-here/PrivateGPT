...
**Diagnosis:** Private_GPT is not installed or not in your Python path.
...
python -m pip install private_gpt
```
...
pip install --upgrade private_gpt

# 3. Install specific version
pip install private_gpt==2024.12.01
...
pip install "private_gpt[api]"

# 2. Install with dev dependencies
pip install "private_gpt[dev]"
...
### Q: How do I use Private_GPT with asyncio?

**A:** Private_GPT is synchronous, but you can use `asyncio` with `run_in_executor`:
...
1. Check the [GitHub Issues](https://github.com/OEvortex/Private_GPT/issues)
...
3. Include:
   ...
   - Private_GPT version: `pip show private_gpt`
...
- **GitHub Issues:** https://github.com/OEvortex/Private_GPT/issues
