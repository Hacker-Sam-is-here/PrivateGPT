...
## 🔗 Integration with Private_GPT

LitPrinter is deeply integrated into the Private_GPT ecosystem and used throughout the codebase.

### Usage in Private_GPT
...
- **Unified styling**: Consistent look and feel across all Private_GPT components
...
See [Private_GPT contributing guidelines](https://github.com/OEvortex/Private_GPT/blob/main/CONTRIBUTING.md) for details.
...
<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/OEvortex/Private_GPT">Private_GPT</a> •
