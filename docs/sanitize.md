# Stream Sanitization Utilities (`private_gpt.sanitize`)
> Last updated: 2025-12-20
> Maintained by [Private_GPT](https://github.com/OEvortex/Private_GPT)

Private_GPT's [`private_gpt.sanitize`](../private_gpt/sanitize.py:1) module provides a comprehensive suite of utilities for processing, transforming, and sanitizing data streams. These tools are designed for robust, flexible, and high-performance handling of text and byte streams, including real-time data, API responses, and streaming content from various sources.
...
### [`sanitize.py`](../private_gpt/sanitize.py:1)

The main sanitization module that provides comprehensive stream processing capabilities.

```python
from private_gpt.sanitize import sanitize_stream, LITSTREAM, sanitize_stream_decorator, lit_streamer
...
### [`sanitize_stream()`](../private_gpt/sanitize.py:684)
...
The [`EncodingType`](../private_gpt/sanitize.py:20) supports a wide range of character encodings:
...
### [`_compile_regexes(patterns)`](../private_gpt/sanitize.py:24)
...
### [`_process_chunk(...)`](../private_gpt/sanitize.py:54)
...
### [`_decode_byte_stream(byte_iterator, ...)`](../private_gpt/sanitize.py:154)
...
### [`_decode_byte_stream_async(byte_iterator, ...)`](../private_gpt/sanitize.py:217)

Asynchronous counterpart to the synchronous byte decoder.

### [`_sanitize_stream_sync(...)`](../private_gpt/sanitize.py:273)

Synchronous stream processing engine with advanced filtering and transformation capabilities.

### [`_sanitize_stream_async(...)`](../private_gpt/sanitize.py:468)
...
```python
from private_gpt.sanitize import sanitize_stream_decorator, lit_streamer
...
- [`sanitize_stream_decorator`](../private_gpt/sanitize.py:1000): Full decorator function
- [`lit_streamer`](../private_gpt/sanitize.py:1001): Short alias for decorator
- [`LITSTREAM`](../private_gpt/sanitize.py:997): Alias for main function

```python
from private_gpt.sanitize import LITSTREAM, lit_streamer
...
# Process streaming responses from Private_GPT providers
provider = ChatGPT()
...
*This documentation covers the comprehensive functionality of the [`private_gpt.sanitize`](../private_gpt/sanitize.py:1) module. For the most up-to-date information, refer to the source code and inline documentation.*
