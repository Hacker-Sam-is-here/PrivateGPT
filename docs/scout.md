...
- [Private_GPT Integration](#-private_gpt-integration)
...
Scout is included with Private_GPT:
...
```python
from private_gpt.scout import Scout
...
```python
from private_gpt.scout import ScoutCrawler
...
## 🔗 Private_GPT Integration

Scout is deeply integrated into Private_GPT's search engines, providing powerful HTML parsing capabilities without external dependencies.

### Why Scout in Private_GPT?
...
For detailed API documentation, please refer to the [documentation](https://github.com/OEvortex/Private_GPT/wiki).
...
<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/OEvortex/Private_GPT/issues">Request Feature</a>
  </p>
</div>