...
While Inferno is now a standalone package, it provides OpenAI-compatible APIs that work seamlessly with Private_GPT's OpenAI-compatible providers. You can use Inferno-hosted local models through Private_GPT's unified interface.
