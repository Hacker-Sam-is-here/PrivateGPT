...
[![PyPI version](https://img.shields.io/badge/View_on-PyPI-orange.svg?style=for-the-badge&logo=pypi&logoColor=white)](https://pypi.org/project/private_gpt/)
...
```python
from private_gpt.swiftcli import CLI, option, table_output
...
```python
from private_gpt.swiftcli import Plugin
...
2. **Structured Error Handling**
   ```python
   from private_gpt.swiftcli import CLIError
...
Made with ❤️ by the [Private_GPT](https://github.com/OEvortex/Private_GPT) team

[![GitHub stars](https://img.shields.io/github/stars/OEvortex/Private_GPT?style=social)](https://github.com/OEvortex/Private_GPT)
