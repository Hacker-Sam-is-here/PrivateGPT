...
Private_GPT's [`AIutel.py`](../private_gpt/AIutel.py:1) module provides powerful utility decorators for function timing and automatic retry logic. These decorators are designed for robust, flexible, and high-performance function enhancement, supporting both synchronous and asynchronous functions with comprehensive error handling and performance monitoring.
...
### [`timeIt`](../private_gpt/AIutel.py:12)
...
```python
from private_gpt.AIutel import timeIt
...
**Key Features:**
- Automatic detection of sync/async functions using [`asyncio.iscoroutinefunction()`](../private_gpt/AIutel.py:36)
- High-precision timing with microsecond accuracy
- Colored terminal output (green bold) for better visibility
- Preserves function metadata with [`functools.wraps`](../private_gpt/AIutel.py:20)
- Zero-configuration setup

### [`retry`](../private_gpt/AIutel.py:41)
...
```python
from private_gpt.AIutel import retry
...
### [`timeIt`](../private_gpt/AIutel.py:12) Parameters
...
### [`retry`](../private_gpt/AIutel.py:41) Parameters
...
### [`timeIt` Decorator](../private_gpt/AIutel.py:12)
...
**Internal Wrappers:**
- [`sync_wrapper`](../private_gpt/AIutel.py:21): Handles synchronous functions
- [`async_wrapper`](../private_gpt/AIutel.py:29): Handles asynchronous functions

### [`retry` Decorator](../private_gpt/AIutel.py:41)
...
```python
from private_gpt.AIutel import timeIt, retry
...
The [`retry`](../private_gpt/AIutel.py:41) decorator handles exceptions gracefully:
...
The [`timeIt`](../private_gpt/AIutel.py:12) decorator uses [`time.time()`](../private_gpt/AIutel.py:22) for timing:
...
The [`timeIt`](../private_gpt/AIutel.py:12) decorator adds minimal overhead:
