...
This guide teaches you how to create custom providers for Private_GPT, enabling integration with new AI services or local models.
...
Create `private_gpt/Provider/YourProvider.py`:
...
Edit `private_gpt/Provider/__init__.py` and add:
...
```python
from private_gpt.Provider.Openai_comp.base import OpenAICompatibleProvider
...
```python
    def create_completion(
        ...
        **kwargs: Any,
        ...
        """
        from private_gpt.Provider.Openai_comp.utils import ChatCompletion
...
**Location:** `private_gpt/Provider/YourProvider.py`
...
**Example:**
```python
from private_gpt import YourProvider
