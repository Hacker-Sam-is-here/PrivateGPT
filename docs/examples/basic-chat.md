...
Simple question-answer patterns with Private_GPT providers.
...
```python
from private_gpt import OpenRouter
...
```python
from private_gpt import Meta, GROQ, OpenAI
...
```python
from private_gpt import GROQ
from private_gpt.exceptions import AIProviderError
...
def main():
    """Simple Q&A bot using Private_GPT."""
    
    print("=" * 60)
    print("Welcome to Private_GPT Q&A Bot")
...
```
==========================================
Welcome to Private_GPT Q&A Bot
