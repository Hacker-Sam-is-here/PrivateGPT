...
```python
from private_gpt import BingSearch
...
```python
from private_gpt import YahooSearch
...
```python
from private_gpt import YepSearch
...
```python
from private_gpt import BraveSearch
...
```python
from private_gpt import Wikipedia
...
```python
from private_gpt import DuckDuckGoSearch, GROQ
...
# News search
private_gpt news -k "technology news"

# Weather
private_gpt weather -l "New York"

# Using different search engine
private_gpt bing_text -k "machine learning"
private_gpt yahoo_text -k "web development"
```
