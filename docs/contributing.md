...
Thank you for considering contributing to Private_GPT. This guide will help you get started with development and ensure your contributions meet our quality standards.
...
# Visit: https://github.com/OEvortex/Private_GPT

# 2. Clone your fork
git clone https://github.com/YOUR-USERNAME/Private_GPT.git
cd Private_GPT

# 3. Add upstream remote
git remote add upstream https://github.com/OEvortex/Private_GPT.git
...
# Check Private_GPT import
python -c "import private_gpt; print(private_gpt.__version__)"
...
from private_gpt.AIbase import Provider
...
from private_gpt.Provider.YourProvider import YourProvider
...
class TestYourProvider(unittest.TestCase):
    ...
    @patch('private_gpt.Provider.YourProvider.Session.post')
...
uv run pytest --cov=private_gpt tests/

# Generate coverage report
uv run pytest --cov=private_gpt --cov-report=html tests/
...
# Check specific file
uv run ruff check private_gpt/Provider/MyProvider.py
...
# Check specific file
uv run ty check private_gpt/Provider/MyProvider.py
```
...
2. **Create PR on GitHub:**
   - Base: `OEvortex/Private_GPT` main
   - Compare: `YOUR-USERNAME/Private_GPT` your-branch
...
- Provider implementations go in `private_gpt/Provider/`
- Search engines go in `private_gpt/search/`
- Utilities go in `private_gpt/Extra/`
...
- **Questions:** [GitHub Discussions](https://github.com/OEvortex/Private_GPT/discussions)
- **Issues:** [GitHub Issues](https://github.com/OEvortex/Private_GPT/issues)
...
Thank you for contributing to Private_GPT!
