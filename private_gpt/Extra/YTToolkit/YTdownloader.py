...
from private_gpt.swiftcli import CLI, argument, option
from private_gpt.version import __prog__

# Define cache directory using tempfile
user_cache_dir = os.path.join(tempfile.gettempdir(), "private_gpt")
