...
YTAPI is a powerful, lightweight YouTube data extraction module within the Private_GPT Python package. It provides comprehensive tools for retrieving YouTube video, channel, playlist, and search data without requiring an API key.
...
```python
from private_gpt.Extra.YTToolkit.ytapi import Video
...
```python
from private_gpt.Extra.YTToolkit.ytapi import Search
...
```python
from private_gpt.Extra.YTToolkit.ytapi import Suggestions
...
```python
from private_gpt.Extra.YTToolkit.ytapi import Shorts
...
```python
from private_gpt.Extra.YTToolkit.ytapi import Hashtag
...
```python
from private_gpt.Extra.YTToolkit.ytapi import Captions
...
```python
from private_gpt.Extra.YTToolkit.ytapi import Extras
...
```python
from private_gpt.Extra.YTToolkit.ytapi import Channel
...
```python
from private_gpt.Extra.YTToolkit.ytapi import Playlist
