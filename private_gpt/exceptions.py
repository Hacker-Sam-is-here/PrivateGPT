...
class Private_GPTE(Exception):
    """
    Base exception class for all Private_GPT related errors.

    This class serves as the root for all custom exceptions raised by the Private_GPT library.
    It provides a common base for catching and handling errors specific to Private_GPT.
    """
    pass


class ModelNotFoundError(Private_GPTE):
    """
...
class MissingRequirementsError(Private_GPTE):
    """
...
class APIConnectionError(Private_GPTE):
    """
...
class AuthenticationError(Private_GPTE):
    """
...
class ConversationLimitException(Private_GPTE):
    """
...
class FailedToGenerateResponseError(Private_GPTE):
    """
...
class InvalidResponseError(Private_GPTE):
    """
...
class ProviderConnectionError(Private_GPTE):
    """
    Exception raised when there are issues connecting to a specific provider.
    """
    pass

class InvalidOptimizerError(Private_GPTE):
    """
...
class AllProvidersFailure(Private_GPTE):
    """
...
class FacebookInvalidCredentialsException(Private_GPTE):
    """
...
class FacebookRegionBlocked(Private_GPTE):
    """
...
class ModelUnloadedException(Private_GPTE):
    """
...
class TranscriptRetrievalError(Private_GPTE):
    """
