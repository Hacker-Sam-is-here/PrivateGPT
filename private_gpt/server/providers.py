"""
Provider management and initialization for the Private_GPT API.
"""
...
def initialize_provider_map() -> None:
    ...
    try:
        from private_gpt.Provider.Openai_comp.base import OpenAICompatibleProvider, SimpleModelList
        module = sys.modules["private_gpt.Provider.Openai_comp"]
        ...
        for name, obj in inspect.getmembers(module):
            if (
                ...
                is_exception = obj.__name__ in ("Copilot", "Venice")
        ...
        if not AppConfig.provider_map:
            ...
            try:
                from private_gpt.Provider.Openai_comp.chatgpt import ChatGPT
...
def initialize_tti_provider_map() -> None:
    ...
    try:
        from private_gpt.Provider.TTI.base import TTICompatibleProvider
        module = sys.modules["private_gpt.Provider.TTI"]
