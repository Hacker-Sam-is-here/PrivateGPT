...
"""
UI Templates for Private_GPT Server.
...
<head>
    ...
    <title>Private_GPT API - Your All-in-One AI Toolkit</title>
    ...
    <header>
        <div class="header-content">
            ...
            <nav class="nav-links">
                ...
                <a href="https://github.com/OEvortex/Private_GPT" class="btn btn-secondary" target="_blank">
    ...
    <main>
        <section class="hero container">
            ...
            <div class="hero-buttons">
                ...
                <a href="https://pypi.org/project/private_gpt/" class="btn btn-ghost" target="_blank">
        ...
        <section class="cta-section container">
            <div class="cta-card">
                ...
                <p class="cta-description">
                    Explore the API documentation, browse available models, or install Private_GPT to begin building.
                </p>
                <div class="hero-buttons">
                    <a href="/docs" class="btn btn-primary">Explore API Docs</a>
                    <a href="https://github.com/OEvortex/Private_GPT" class="btn btn-secondary" target="_blank">View on GitHub</a>
                </div>
            </div>
        </section>
    </main>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-links">
                    ...
                    <a href="https://github.com/OEvortex/Private_GPT" class="footer-link" target="_blank">GitHub</a>
                    <a href="https://pypi.org/project/private_gpt/" class="footer-link" target="_blank">PyPI</a>
                    <a href="https://t.me/OEvortexAI" class="footer-link" target="_blank">Telegram</a>
                </div>
                <p class="footer-credit">
                    © 2025 Private_GPT — Made with ❤️ by <a href="https://github.com/OEvortex" target="_blank">OEvortex</a> & Open Source Community
                </p>
            </div>
        </div>
    </footer>
...
SWAGGER_CSS = """
/* Private_GPT Custom Light Swagger Theme */
:root {
    --bg-color: #f8fafc;
    --header-bg: #ffffff;
    --border-color: #e2e8f0;
