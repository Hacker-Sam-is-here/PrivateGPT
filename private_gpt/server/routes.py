"""
API routes for the Private_GPT server.
"""
...
from private_gpt.search.engines import ENGINES
...
class Api:
    ...
    def register_validation_exception_handler(self):
        ...
        github_footer = "If you believe this is a bug, please pull an issue at https://github.com/OEvortex/Private_GPT."
    ...
    def _register_health_route(self):
        ...
        async def health_check():
            ...
            return {"status": "healthy", "service": "private_gpt-api", "version": "0.2.0"}
        ...
        async def list_models():
            ...
            for model_name, provider_class in AppConfig.provider_map.items():
                ...
                models.append({
                    ...
                    "owned_by": 'private_gpt'  # Set owned_by to private_gpt
                })
                    ...
                    return JSONResponse(
                        ...
                        content={
                            "error": {
                                "message": e.message,
                                "type": e.error_type,
                                "footer": "If you believe this is a bug, please pull an issue at https://github.com/OEvortex/Private_GPT."
                            }
                        }
                    )
                except Exception as e:
    ...
    def _register_websearch_routes(self):
        ...
        async def websearch(
            ...
            github_footer = "If you believe this is a bug, please pull an issue at https://github.com/pyscout/Private_GPT."
            try:
