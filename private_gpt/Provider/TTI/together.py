...
class Images(BaseImages):
    ...
    def _generate_consistent_fingerprint(self) -> Dict[str, str]:
        ...
        """
        from private_gpt.litagent.constants import BROWSERS, FINGERPRINTS
