<div align="center">
  <h1>🔍 Private_GPT AI Search Providers</h1>
...
```python
from private_gpt.Provider.AISEARCH import PERPLEXED
...
```python
from private_gpt.Provider.AISEARCH import Perplexity
...
```python
from private_gpt.Provider.AISEARCH import IAsk
