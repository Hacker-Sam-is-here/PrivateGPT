...
from private_gpt.AIbase import AISearch, SearchResponse
...
class webpilotai(AISearch):
    ...
    Basic Usage:
        >>> from private_gpt import webpilotai
        >>> ai = webpilotai()
...
if __name__ == "__main__":
    ...
    ai = webpilotai()
    resp = ai.search("private_gpt python package details", stream=True, raw=False)
