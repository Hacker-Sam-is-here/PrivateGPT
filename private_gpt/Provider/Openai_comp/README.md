<div align="center">
  <a href="https://github.com/pyscout/Private_GPT">
    <img src="https://img.shields.io/badge/private_gpt-OpenAI%20Compatible%20Providers-4285F4?style=for-the-badge&logo=openai&logoColor=white" alt="private_gpt OpenAI Compatible Providers">
  </a>
  <br/>
  <h1>private_gpt OpenAI-Compatible Providers</h1>
...
The private_gpt OpenAI-Compatible Providers module offers a standardized way to interact with various AI providers using the familiar OpenAI API structure. This makes it easy to:
...
```python
from private_gpt.client import DeepInfra
...
```python
from private_gpt.client import Glider
...
```python
from private_gpt.client import X0GPT
...
```python
from private_gpt.client import WiseCat
...
```python
from private_gpt.client import ExaAI
...
```python
from private_gpt.client import HeckAI
...
```python
from private_gpt.client import TypeGPT
...
```python
from private_gpt.client import FreeAIChat
...
```python
from private_gpt.client import LLMChatCo
...
```python
from private_gpt.client import YEPCHAT
...
```python
from private_gpt.client import SonusAI
...
```python
from private_gpt.client import Ayle
...
```python
from private_gpt.client import Netwrck
...
```python
from private_gpt.client import StandardInput
...
1.  Create a new file in the `private_gpt/Provider/OPENAI` directory
