# 🎙️ Private_GPT Text-to-Speech (TTS) Providers

## Overview

Private_GPT's TTS Providers offer a versatile and powerful text-to-speech conversion library with support for multiple providers and advanced features.
...
```python
from private_gpt.Provider.TTS import ElevenlabsTTS
...
```python
from private_gpt.Provider.TTS import AsyncElevenlabsTTS
import asyncio
