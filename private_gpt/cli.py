...
app: CLI = CLI(name="private_gpt", help="Search the web with a simple UI", version=__version__)


@app.command()
def version() -> None:
    """Show the version of private_gpt."""
    rprint(f"[bold cyan]private_gpt version:[/bold cyan] {__version__}")
